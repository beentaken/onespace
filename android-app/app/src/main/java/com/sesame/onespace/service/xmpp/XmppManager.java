...
public class XmppManager {
    ...
    private XMPPBOSHConnection mBoshConnection = null;
    ...
    private void xmppDisconnect(XMPPTCPConnection connection) {
        class DisconnectRunnable implements Runnable {
            private XMPPTCPConnection con;

            public DisconnectRunnable(XMPPTCPConnection con) {
                this.con = con;
            }
    ...
    private void onConnectionEstablished(XMPPTCPConnection connection) {
        ...
        //Log.i("connection established with parameters: con=" + mConnection.isConnected() + " auth=" + mConnection.isAuthenticated() + " comp=" + mConnection.isUsingCompression());
    ...
    private void createAccount(XMPPTCPConnection connection) throws SmackException.NotConnectedException,
    ...
    private static XMPPTCPConnection createNewConnection(SettingsManager settings) throws XMPPException {
    ...
    public long send(ChatMessage chatMessage) {
        if (isConnected()) {
            ...
            //Log.i("Adding message: \"" + chatMessage.getBody() + "\" to offline queue, because  we are not connected. Status=" + statusString());
    ...
    private void informListeners(XMPPTCPConnection connection) {
