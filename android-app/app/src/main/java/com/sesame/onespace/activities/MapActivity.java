...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
        OnLocationUpdatedListener, GoogleMap.OnCameraChangeListener,
    ...
    private static final int WALKER_LIMIT = 100;
    private static final int SURFER_LIMIT = 100;
    private static final int CORNER_LIMIT = 100;
    ...
    protected void onStop() {
        ...
        mPreferencesManager.saveLocation(new LatLng(latitude, longitude));
    }
    ...
    public void onMapReady(GoogleMap map) {
        ...
        map.moveCamera(CameraUpdateFactory.newLatLngZoom(
                new LatLng(latitude, longitude), 11f));
    }
    ...
    private void collapseMap() {
        if (mOneSpaceMap != null) {
            mOneSpaceMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(latitude, longitude), 18f), 1000, null);
        }
    }
