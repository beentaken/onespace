...
/**
 * Created by chongos on 11/11/15 AD.
 */
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<ImageView> {
    ...
    private void bindDimensions() {
        mAvatarMaxSize = mContext.getResources().getDimension(R.dimen.avatar_xlarge);
    }
    ...
    private void shouldInitProperties(ImageView child, View dependency) {
        ...
        if (finalHeight == 0)
            finalHeight = mContext.getResources().getDimensionPixelOffset(R.dimen.avatar_small);
