...
public class LastTweetsListFragment extends Fragment {
    ...
    private void initDefaultValue(LayoutInflater inflater, ViewGroup container){
        ...
        this.view = inflater.inflate(R.layout.fragment_dashboard_twitter, container, false);
    ...
    private void loadData() {
        ...
        while (index < length){
            ...
            try {
                ...
                items.add(new LastTweetsItem(String.valueOf(object.get("tweet_screen_name")), DateConvert.convertTimeStampToDate(String.valueOf(object.get("tweet_timestamp")), "EEE, dd MMM yyyy HH:mm:ss"), String.valueOf(object.get("tweet_text")), R.drawable.ic_dashboard_twitter));
    ...
    public class LastTweetsListAdapter extends RecyclerView.Adapter<LastTweetsListFragment.ViewHolder> {
        ...
        public LastTweetsListFragment.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            //init
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_dashboard_twitter_list, null);
