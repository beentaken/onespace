...
public final class QAListFragment
        extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        QAListFragment.this.view = inflater.inflate(R.layout.fragment_qa_main, container, false);
    ...
    public void onResume(){
        ...
        LinearLayout linearLayout = (LinearLayout) QAListFragment.this.view.findViewById(R.id.empty_chat_state_view);
        if (QAListFragment.this.qaMessageHelper.getCount() != 0){
        ...
        QAListFragment.this.items.clear();

        int index = 0;

        for (QAMessage qaMessage : QAListFragment.this.list){

            QAListFragment.this.items.add(new QAListItem(R.drawable.ic_qa_message_row, qaMessage));
        ...
        QAListFragment.this.bThread = true;
        ...
        Thread thread = new Thread(){
            ...
            public void run(){
                ...
                while (QAListFragment.this.bThread == true){

                    QAListFragment.this.handler.post(new Runnable() {
    ...
    public void onPause(){
        ...
        QAListFragment.this.bThread = false;
    ...
    private class QAListAdapter
            extends RecyclerView.Adapter<QAListFragment.ViewHolder> {
