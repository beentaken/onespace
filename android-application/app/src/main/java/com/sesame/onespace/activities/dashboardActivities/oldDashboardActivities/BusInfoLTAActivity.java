...
public class BusInfoLTAActivity extends DashboardActivity{
    ...
    private void initActivity(){
        ...
        setContentView(R.layout.activity_businfolta_list);
    ...
    private void initToolbar(){
        ...
        this.mToolBar.setTitle("BusInfo(LTA)");
        this.mToolBar.setSubtitle("test sub title");
        this.mToolBar.setLogo(R.drawable.ic_dashboard_bus_info);
